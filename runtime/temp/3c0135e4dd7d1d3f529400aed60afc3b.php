<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/goods\categoryLists.html";i:1541389011;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
                            ...
                            <tr id="row130" data-id="130" class="">
                                ...
                                <td class="handle" align="center">
                                    <div style="text-align: center; width: 150px;">
                                        <a class="btn red" data-url="<?php echo U('Admin/Goods/categoryListHandle',array('id'=>$vo[id])); ?>"  onclick="delRegion(this);"><i class="fa fa-trash-o"></i>删除</a>
										<span class="btn"><em><i class="fa fa-cog"></i>设置 <i class="arrow"></i></em><ul>
                                            <li><a href="<?php echo U('Admin/Goods/categoryLists',array('op'=>'add','parent_id'=>$vo['id'])); ?>">新增该下属</a></li>
                                            <li><a href="<?php echo U('Admin/Goods/categoryLists',array('parent_id'=>$vo['id'])); ?>">查看该下属</a></li>
                                            <li><a href="<?php echo U('Admin/Goods/categoryEdit',array('id'=>$vo['id'])); ?>">编辑该分类</a></li>
                                        </ul></span></div>
                                </td>
                                <td class="" align="left">
    ...
    <div id="add_region" style="display: none">
        <div class="page">
            ...
            <form id="add_region_form" enctype="multipart/form-data" method="post" action="<?php echo U('Goods/categoryListHandle'); ?>">
...
<script>
    ...
    {
        window.location.href = "<?php echo U('Goods/categoryLists',array('parent_id'=>$parent[parent_id])); ?>";
    }
