<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/admin/view2/comment\ajaxindex.html";i:1536115483;}*/ ?>
<table>
 	<tbody>
  	...
  	<tr data-id="<?php echo $list['comment_id']; ?>">
        ...
        <td align="center" abbr="article_show" axis="col5" class="" style="white-space: normal;">
            <div style="text-align: left; width: 200px;white-space: normal;height:inherit;line-height: inherit;" class="">
          		<a href="<?php echo U('admin/Order/detail',array('order_id'=>$list[order_id])); ?>">
                    <?php echo getOrderSn($list['order_id']); ?>
                </a>
          	</div>
        </td>
