<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin\login.html";i:1534750608;}*/ ?>
<!doctype html>
...
<body>
            ...
            <div class="login-form" style="position: relative">
                <div class="formContent">
                    ...
                    <div class="formInfo">
                        ...
                        <div class="formText">
                            <a href="<?php echo U('Admin/Admin/forget_pwd'); ?>" class="forget_pwd">忘记密码？</a>
                        </div>
    ...
    <div id="bannerBox">
        <ul id="slideBanner" class="slideBanner">
            <li><img style="width: 100%;height: 100%;" src="__PUBLIC__/static/images/banner1.jpg"></li>
            <li><img style="width: 100%;height: 100%;" src="__PUBLIC__/static/images/banner2.jpg"></li>
        </ul>
    </div>
