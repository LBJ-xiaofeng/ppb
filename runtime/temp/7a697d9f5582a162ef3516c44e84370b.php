<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view2/user\ajaxindex.html";i:1535953815;}*/ ?>
    ...
    <table>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <!--<td align="left" class="">-->
                    <!--<div style="text-align: center; width: 100px;"><?php echo getUserPint($list['user_id']); ?></div>-->
                <!--</td>-->
                <td align="left" class="">
                    <div style="text-align: center; width: 100px;"><?php echo getSumOrder($list['user_id'])['a']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 100px;"><?php echo $list['pay_points']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 150px;"><?php echo $list['email']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 80px;"><?php echo $list['mobile']; ?></div>
                </td>
                <!--<td align="left" class="">-->
                    <!--<div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i',$list['reg_time']); ?></div>-->
                <!--</td>-->
                <td align="left" class="">
                    <div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i',$list['last_login']); ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 120px;"><?php echo $list['last_ip']; ?></div>
                </td>
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:250px;">
                        ...
                        <a class="btn red"  href="javascript:void(0)" data-id="<?php echo $list['user_id']; ?>" data-role="<?php echo $role; ?>"  data-url="<?php echo U('Admin/user/ajax_delete'); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                    </div>
                </td>
    ...
    function delfun(obj) {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                ...
                data: {id : $(obj).attr('data-id'),role:$(obj).attr('data-role')},
                dataType: 'json',
