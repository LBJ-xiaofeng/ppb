<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\phpstudy\WWW\ppb/application/ppb\view\ppb\yyqj.html";i:1539061641;}*/ ?>
<!doctype html>
<html>
				...
				$.ajax({
		            ...
		            success : function(data){
		            	if (data.status==0) {
		            		...
		            		window.location.href = "<?php echo U('ppb/ppb/yycg'); ?>";
		            	}
		            }	
				});
