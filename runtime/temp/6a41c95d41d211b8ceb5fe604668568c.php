<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/index\index.html";i:1534904881;s:42:"./application/admin/view2/public\left.html";i:1528341077;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
     <h2 style="cursor:pointer;font-size: 26px;font-size: 20px;text-align: center;line-height: 50px;"><?php echo $tpshop_config['shop_info_store_name']; ?>系统管理</h2>

  </div>
  <div class="nc-module-menu">
    <ul class="nc-row">
      <li data-param="system"><a href="javascript:void(0);">系统</a></li>
      <li data-param="shop"><a href="javascript:void(0);">订单</a></li>
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <div class="manager-menu">
        ...
        <div class="title">
          <h4>常用操作</h4>
          <!--<a href="javascript:void(0)" class="add-menu"></a> -->
        </div>
    ...
    <ul class="operate nc-row">
      <li style="display: none !important;" tptype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://#/admin/index.php?act=common&op=pending_matters', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li>
      ...
      <li><a class="homepage show-option" target="_blank" href="/woodenDoor/Index/index" title="新窗口打开首页">&nbsp;</a></li>
