<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/report\index.html";i:1536197127;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>概况</h3>
				<h5>今日成功交易总金额：￥<?php if(empty($today['today_amount']) || (($today['today_amount'] instanceof \think\Collection || $today['today_amount'] instanceof \think\Paginator ) && $today['today_amount']->isEmpty())): ?>0<?php else: ?><?php echo $today['today_amount']; endif; ?>|单均价：￥<?php echo $today['sign']; ?>|今日已付款订单数：<?php echo $today['today_order']; ?>|今日待付款订单：<?php echo $today['cancel_order']; ?></h5>
			</div>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="ac_id" axis="col4" class="">
							<div style="text-align: center; width: 100px;" class="">所有订单数</div>
						</th>
						<th align="center" abbr="article_show" axis="col5" class="">
							<div style="text-align: center; width: 100px;" class="">交易总金额</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 100px;" class="">单均价</div>
						</th>
