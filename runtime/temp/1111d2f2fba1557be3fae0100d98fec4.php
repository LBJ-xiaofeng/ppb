<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\phpstudy\WWW\ppb/application/ppb\view\ppb\gj_allorder.html";i:1540883010;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>订单管理</title>
...
<body>
  ...
  <h1 class="mui-title" style="color: #fff;">订单管理</h1>
     ...
     <ul class="mine-ul1">
     	<a href="<?php echo U('ppb/ppb/gj_allorder'); ?>" >
             <li class="active">
            全部
        </li>
        </a>
         <a href="<?php echo U('ppb/ppb/gj_ddgl'); ?>"style="	color: black;" >
         <li>
            待定损
        </li>
        </a>
...
var number;
    $.ajax({
		...
		data: {admin_id:localStorage.getItem('admin_id'),type:4,page:page},
