<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/article\articleList.html";i:1535953360;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
          ...
          <thead>
            <tr>
              ...
              <th align="left" abbr="ac_id" axis="col4" class="">
                <div style="text-align: left; width: 150px;" class="">资讯分类</div>
              </th>
    ...
    <div class="tDiv">
      <div class="tDiv2">
          <div class="fbutton"> 
        	<a href="<?php echo U('Admin/Article/article'); ?>"><div class="add" title="新增资讯"><span><i class="fa fa-plus"></i>新增资讯</span></div></a>
          </div>
