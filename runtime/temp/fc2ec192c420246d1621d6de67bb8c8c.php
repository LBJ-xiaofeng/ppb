<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/user\recharge.html";i:1537495529;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 150px;" class="">成功时间</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <table>
                    ...
                    <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;"><?php echo date("Y-m-d H:i",$list['pay_time']); ?></div>
                            </td>
                            <td align="center" class="">
