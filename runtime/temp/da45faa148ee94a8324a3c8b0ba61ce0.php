<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\phpstudy\WWW\ppb/application/ppb\view\Admin\edit_order1.html";i:1538025384;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <form class="form-horizontal" action="" id="order-add" method="post">
            ...
            <text class="content"><?php echo $data['mobile_name']; ?>-<?php echo $data['attr_name']; ?>-<?php echo $data['brand_name']; ?></text>
                <div for="consignee" class="consignee">步骤一</div>
                <div class="adiv">
                    <input type="text" name="first_start_time" id="first_start_time" value="<?php echo $data['first_start_time']; ?>" class="input-txt" placeholder="步骤一开始时间" />
                    <p class="notic">开始时间,格式：2018/02/15</p>
                </div>
                
                <div class="bdiv">
                    <input type="text" name="first_end_time" id="first_end_time" value="<?php echo $data['first_end_time']; ?>" class="input-txt" placeholder="步骤一完成时间"/>
                    <p class="notic">完成时间,格式：2018/02/15</p>
                </div>
                
                <div class="cdiv">
                     <input type="text" name="first_content" id="first_content" value="<?php echo $data['first_content']; ?>" class="input-txt" placeholder="步骤一描述"/>
...
<script type="text/javascript">
    ...
    {
        var val=$('#first_content').val().length;
        if(val>10){
            alert('描述超过10个字符')
        }else{
            $.ajax({
