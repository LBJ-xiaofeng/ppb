<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/user\add_user.html";i:1541396438;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" method="post" id="add_form">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="mobile" id="mobile" class="input-txt" value="<?php echo $mobile; ?>">
                    <span class="err"></span>
