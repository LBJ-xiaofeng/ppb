<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1535618182;}*/ ?>
<html>
<head>
        ...
        <div class="contentWarp">
            <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_price" style="width: 30%;">
                    ...
                    <div class="item item_order"  style="width: 30%;">
                        <i class="icon"><img src="__PUBLIC__/static/images/2.png"  height="74"></i>
                        <div class="desc">
                    ...
                    <div class="item item_flow" style="width: 30%;">
                        <i class="icon"><img src="__PUBLIC__/static/images/4.png" width="86" height="74"></i>
                        <div class="desc">
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td>皮皮班<?php echo $sys_info['version']; ?></td>
                                <td class="gray_bg">更新时间:</td>
                                <td><?php echo date('Y-m-d');?></td>
                            </tr>
                            <tr>
                                <td class="gray_bg">程序开发:</td>
                                <td>北京启智航创网络科技有限公司</td>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 北京启智航创网络科技有限公司，并保留所有权利。</b></p>
</div>
