<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/system\shop_info.html";i:1536835213;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li>系统平台全局设置,包括基础设置、短信、邮件等相关模块。</li>
        </ul>
    </div>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic">默认网站LOGO,通用顶部显示，最佳显示尺寸为240*60像素</p>
                </dd>
            </dl>
            <!--<dl class="row">-->
                <!--<dt class="tit">-->
                    <!--<label for="store_logo">首页视频</label>-->
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<div class="input-file-show">-->
           	            <!--<span class="type-file-box">-->
                            <!--<input type="text" id="store_user_logo" value="<?php echo $config['store_user_logo']; ?>" class="type-file-text">-->
                            <!--<input type="button" name="button" id="button" value="选择上传..." class="type-file-button" style="cursor: pointer;">-->
                            <!--<input type="file" style="display: none;" id="file" name="store_user_logo" value="选择上传...">-->

                        <!--</span>-->
                    <!--</div>-->
                    <!--<span class="err"></span>-->
                    <!--<p class="notic">首页视频,若上传视频，则优先使用上传的视频，若无，使用填写的链接，上传视频20M以内</p>-->
                <!--</dd>-->
            <!--</dl>-->
            <!--<dl class="row">-->
                <!--<dt class="tit">-->
                    <!--<label for="form_submit">首页视频链接</label>-->
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<input id="form_submit" name="form_submit" value="<?php echo $config['form_submit']; ?>" class="input-txt" type="text" />-->
                    <!--<p class="notic">首页视频链接，若无上传视频，选择该链接视频播放</p>-->
                <!--</dd>-->
            <!--</dl>-->
            <dl class="row">
                <dt class="tit">
