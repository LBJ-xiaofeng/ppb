<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view2/tools\categoryEdit.html";i:1540867935;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div id="add_region">
        <div class="page" style="padding-top: 0px;">
            ...
            <form id="add_region_form" enctype="multipart/form-data" method="post" action="<?php echo U('Tools/categoryEdit'); ?>">
