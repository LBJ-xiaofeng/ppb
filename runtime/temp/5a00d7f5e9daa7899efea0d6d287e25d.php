<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/admin/view2/public\dispatch_jump.html";i:1535618182;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			...
			<div class="recigle">
				<p>Copyright©<em class="copyright"><a class="copyright" href="#">皮皮班</a></em></p>
				<p><em class="copyright"><a class="copyright" href="#">北京启智航创网络科技有限公司</a></em>出品</p>
			</div>
		</div>
