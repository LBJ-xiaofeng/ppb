<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/admin\role.html";i:1536633068;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" abbr="ac_id" axis="col4" class="">
							<div style="text-align: left; width: 200px;" class="">角色名称</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): if($vo['role_id'] > 1): ?>
							<tr>
								...
								<td align="left" class="">
									<div style="text-align: left; width: 200px;"><?php echo $vo['role_desc']; ?></div>
								</td>
