<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/article\categoryList.html";i:1535953436;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>新增文章时，可选择资讯分类</li>
      <li>系统分类为显示状态或系统默认分类不可以删除</li>
      <li>系统分类下有资讯时不可以删除</li>
    </ul>
  </div>
  <form method="post">
