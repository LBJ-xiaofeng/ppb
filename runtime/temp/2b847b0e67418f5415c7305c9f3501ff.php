<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user\index.html";i:1540522123;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline"  id="search-form2" onsubmit="return false">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" id="search_key" size="30" name="mobile" class="qsbox" placeholder="手机">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <!--<th align="center" abbr="level" axis="col5" class="">-->
                            <!--<div style="text-align: center; width: 100px;" class="">会员等级</div>-->
                        <!--</th>-->
                        <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">累计订单(笔)</div>
                        </th>
                        <th align="center" abbr="total_amount" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">累计消费(元)</div>
                        </th>
                        ...
                        <!--</th>-->
                        <th align="center" abbr="reg_time" axis="col6" class="">
                            <div style="text-align: center; width: 120px;" class="">最后登录</div>
                        </th>
                        <th align="center" abbr="reg_time" axis="col6" class="">
                            <div style="text-align: center; width: 120px;" class="">最后ip</div>
                        </th>
