<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"E:\phpstudy\WWW\ppb/application/ppb\view\ppb\gj_dsh.html";i:1540883495;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>订单管理</title>
...
<body>
  ...
  <h1 class="mui-title" style="color: #fff;">订单管理</h1>
     ...
     <a href="<?php echo U('ppb/ppb/gj_allorder'); ?>" style="color: black;">
        ...
        <a href="<?php echo U('ppb/ppb/gj_dsh'); ?>">
            <li class="active">
          待送回
        </li>
        </a>
...
var number;
	 $.ajax({
		...
		data: {admin_id:localStorage.getItem('admin_id'),type:2,page:page},
