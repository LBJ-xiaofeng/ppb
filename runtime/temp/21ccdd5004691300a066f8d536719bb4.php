<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/user\address.html";i:1528431539;s:44:"./application/admin/view2/public\layout.html";i:1528854675;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 300px;" class="">是否为默认</div>
                        </th>
                        ...
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 300px;">
                                    <?php echo get_region2($list['province']); ?><?php echo get_region2($list['city']); ?><?php echo get_region2($list['district']); ?><?php echo $list['address']; ?>
                                </div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 300px;">
