...
class OrderLogic extends Model
{
    ...
    public function getOrderGoods($order_id,$is_send =''){
        ...
        $sql = "SELECT g.*,o.* FROM __PREFIX__order_goods o ".
    ...
    public function getOrderInfo($order_id)
    {
        ...
        $order['address2'] = $this->getAddressName($order['province'],$order['city'],$order['twon']);
