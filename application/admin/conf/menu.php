...
//						array('name'=>'地区&配送','act'=>'region','op'=>'Tools'),
						array('name'=>'服务区域','act'=>'ktcity','op'=>'Tools'),
...
//						array('name'=>'自提点','act'=>'index','op'=>'Pickup'),
				...
				array('name' => '会员','child'=>array(
						...
						array('name'=>'推荐奖品','act'=>'rewardList','op'=>'User'),
//						array('name'=>'会员等级','act'=>'levelList','op'=>'User'),
						array('name'=>'充值记录','act'=>'recharge','op'=>'User'),
//						array('name'=>'提现记录','act'=>'withdrawals','op'=>'User'),
...
//						array('name'=>'广告位置','act'=>'positionList','op'=>'Ad'),
				...
				array('name' => '物品管理','child' => array(
					    array('name'=>'物品分类','act'=>'categoryList','op'=>'Tools'),
						array('name'=>'品牌/种类','act'=>'brandsList','op'=>'Topic'),
						//array('name'=>'保养类型','act'=>'cate2List','op'=>'Topic'),
				)),
				array('name' => '资讯/关于','child'=>array(
						array('name' => '资讯列表', 'act'=>'articleList', 'op'=>'Article'),
						array('name' => '资讯分类', 'act'=>'categoryList', 'op'=>'Article'),
						array('name'=>'我们/协议','act'=>'articleTwo','op'=>'Article'),
						array('name' => '问题管理', 'act'=>'commonProblemsList', 'op'=>'Article'),
						array('name' => '反馈管理', 'act'=>'opinionList', 'op'=>'Article'),
						//array('name'=>'友情链接','act'=>'linkList','op'=>'Article'),
...
//						array('name' => '工端账号列表', 'act'=>'adminUser', 'op'=>'Admin'),
...
//				))
	...
	'shop'=>array('name'=>'店铺','child'=>array(
					array('name' => '样例','child' => array(
				    array('name' => '样例列表', 'act'=>'goodsList', 'op'=>'Goods'),
					array('name' => '样例分类', 'act'=>'categoryLists', 'op'=>'Goods'),
//					array('name' => '库存日志', 'act'=>'stock_list', 'op'=>'Goods'),
//					array('name' => '商品模型', 'act'=>'goodsTypeList', 'op'=>'Goods'),
//					array('name' => '店铺管理', 'act'=>'shopList', 'op'=>'Goods'),
...
//					array('name' => '商品咨询', 'act'=>'ask_list', 'op'=>'Comment'),
			...
			array('name' => '订单','child'=>array(
					...
					array('name' => '评论列表', 'act'=>'index', 'op'=>'Comment'),
					array('name' => '订单工艺', 'act'=>'orderProcess', 'op'=>'Order'),
//					array('name' => '兑换订单', 'act'=>'apply_list', 'op'=>'Order'),
//					array('name' => '发货单', 'act'=>'delivery_list', 'op'=>'Order'),
//					array('name' => '退款单', 'act'=>'refund_order_list', 'op'=>'Order'),
//					array('name' => '更换商品', 'act'=>'return_list', 'op'=>'Order'),
...
//					array('name' => '团购促销', 'act'=>'prom_goods_list', 'op'=>'Promotion'),
...
//					array('name' => '分销列表', 'act'=>'goods_list', 'op'=>'Distribut'),
//					array('name' => '代理申请列表', 'act'=>'distributor_list', 'op'=>'Distribut'),
...
//
    	    array('name' => '微信','child' => array(
    	        array('name' => '微信配置', 'act'=>'index', 'op'=>'Wechat'),
...
//    	        array('name' => '图文回复', 'act'=>'img', 'op'=>'Wechat'),
			...
			array('name' => '统计','child' => array(
					array('name' => '交易概况', 'act'=>'index', 'op'=>'Report'),
//					array('name' => '回收排行', 'act'=>'saleTop', 'op'=>'Report'),
					array('name' => '会员排行', 'act'=>'userTop', 'op'=>'Report'),
//					array('name' => '回收明细', 'act'=>'saleList', 'op'=>'Report'),
