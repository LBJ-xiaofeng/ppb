...
class Ad extends Base{
    ...
    public function adList(){
        ...
        $ad_position_list = M('AdPosition')->where('is_open',1)->getField("position_id,position_name,is_open");
...
//        $data['ad_link']='http://'.$_SERVER['HTTP_HOST'].'/index.php/goods/goodsInfo/goods_id/'.$data['goods_id'];
//        print_r($data);die;
    	if($data['act'] == 'add'){
    		$r = D('ad')->add($data);
    	}
